...
<body>
    <header>
        ...
        <div class="navlinks">
            <a id="sign" href="login.php">Sign in</a>
            <a id ="create" href="register.php"> Create account</a>
            <a id="for" href="For artists">For artists</a>
        </div>
    </header>
    ...
    <a href="#"><p id="find">Find out more</p></a>

    <span id="end1">Thanks for listening. Now join in.</span>

    <span id="end2">Save tracks, follow artists and build playlists. All for free.</span>

    <a href="register.php"><p id="createf">Create Account</p></a>

    <a id="alr">Already have an account?</span>

    <a href="login.php" id="signf">Sign in</a>
